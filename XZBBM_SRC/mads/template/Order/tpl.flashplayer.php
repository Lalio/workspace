...
<script type="text/javascript" src="./script/js/order.js?v=100"></script>
<script type="text/javascript">
	var __Host = "<?= $_SERVER[HOSTNAME] == 't3.56.com'?$_SERVER[HOSTNAME]:'mads.56.com'?>";
	var __Encode = "utf8";
</script>
<div class="ctr_panel">
	<br>
	...
	<tr>
		...
		<tr>
			...
			<td><a class="tpl_state" id="<?= $data['id']?>" state="<?= $data['state']?>" href="javascript:;"><?= $data['state']==0?'<font color="green"> [有效] </font>':'<font color="red"> [无效] </font>'?></a></td>
	        <td>
	        	<p align="center">
	        		<!-- 
