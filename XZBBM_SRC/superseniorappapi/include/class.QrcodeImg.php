...
*/
//import("@.ORG.qrcode");
//import("@.ORG.RoundedCorner");
require "class.Qrcode.php";
require "class.RoundedCorner.php";

class QrcodeImg extends Qrcode{
     ...
     */
    function qrcode_image_out($org_data,$filename,$imgwh=380,$filelogo='',$filebg='',$ptcolor='#000000',$inptcolor='#000000',$fcolor='#000000',$bcolor='#FFFFFF',$ccolor='#000000',$style=1){
    ...
    function mkimage($data,$ptcolor,$inptcolor,$fcolor,$bcolor,$ccolor,$style){
    ...
    //半角
    function halfcorner($img,$x,$y,$s,$bcolor,$fcolor,$lt=TRUE,$lb=TRUE,$rb=TRUE,$rt=TRUE) {
        //左上半角
        if($lt){
    ...
    //半圆
    function halfrounded($img,$x,$y,$s,$color,$t=TRUE,$l=TRUE,$b=TRUE,$r=TRUE) {
        //上半圆
        if($t){
    ...
    //圆角
    function roundedcorner($img,$x,$y,$s,$color,$lt=TRUE,$lb=TRUE,$rb=TRUE,$rt=TRUE) {
        if($lt){
            imagefilledarc($img, ($x*$s)+($s/2), ($y*$s)+($s/2), $s, $s, 180, 270, $color, IMG_ARC_PIE);
