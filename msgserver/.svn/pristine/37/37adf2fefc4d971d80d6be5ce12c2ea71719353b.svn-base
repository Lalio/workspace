...
public class Status implements Serializable {
    ...
    private int railStatus;
    
    public int getRailStatus() {
		return railStatus;
	}

	public void setRailStatus(int railStatus) {
	...
	//public void setIsCmd(int isCmd) {
		//this.isCmd = isCmd;
	//}
	...
	public byte[] getTroubles() {
		return troubles;
	}

	public void setTroubles(byte[] troubles) {
